...
TURN_SCALE_LEFT  = 1.65
TURN_SCALE_LEFT_OPEN = 1.55
TURN_SCALE_LEFT_CLOSED = 1.65
...
def Drive_Forward_mm(dist_mm):
    ...
    while True:
        ...
        Right_PWM = int(round(Right_PWM * 1.01))
...
def Wall_Turn_Right():
    ...
    Drive_Forward_mm(150)
    time.sleep(0.05)
    
    Drive_Forward_mm_Crashable(15)
    time.sleep(0.05)
