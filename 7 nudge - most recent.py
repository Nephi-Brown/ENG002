...
RIGHT_WALL_TARGET = 35    # mm, desired distance from the right wall
...
TURN_SCALE_LEFT_OPEN = 1.74
TURN_SCALE_LEFT_CLOSED = 1.75
...
def Drive_Forward_mm(dist_mm):
    ...
    while True:
        ...
        Right_PWM = int(round(Right_PWM * 1.0))
...
try:
    ...
    while True:
        ...
        if raw_left_mm > 10 and raw_left_mm <= 15:
        ...
        if raw_right_mm > 10 and raw_right_mm <= 15:
