...
CENTER_GAIN = 40          # steering strength
MAX_STEER = 500
...
TURN_SCALE_LEFT  = 1.71
TURN_SCALE_LEFT_OPEN = 1.705
TURN_SCALE_LEFT_CLOSED = 1.71

TURN_SCALE_RIGHT = 1.67
TURN_SCALE_RIGHT_OPEN = 1.65
TURN_SCALE_RIGHT_CLOSED = 1.67
...
Turn_Extra_mm_Small = 15
Turn_Extra_mm_None = 0
Turn_Extra_mm = Turn_Extra_mm_None
...
def Drive_Forward_mm(dist_mm):
    ...
    while True:
        ...
        Left_PWM = int(round(Left_PWM * 0.995))
        Right_PWM = int(round(Right_PWM * 1.005))
...
try:
    ...
    while True:
        ...
        if raw_left_mm > 0 and raw_left_mm <= 10:
            Drive_Forward_mm(Turn_Extra_mm)
            Right_Straight_Turn()
            Drive_Forward_mm(1)
            Reset_State()
            continue
        ...
        if right_triggered:
            ...
            Turn_Extra_mm = Turn_Extra_mm_Small
