...
MAX_STEER = 500
RIGHT_WALL_TARGET = 38    # mm, desired distance from the right wall
...
TURN_SCALE_LEFT  = 1.695
TURN_SCALE_RIGHT = 1.645

MIN_FRONT_DIST = 60      # mm: if front distance below this, handle front wall
