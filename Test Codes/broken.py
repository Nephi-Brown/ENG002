...
TURN_SCALE_LEFT  = 1.755
TURN_SCALE_RIGHT = 1.6325

MIN_FRONT_DIST = 50      # mm: if front distance below this, handle front wall
...
def Detect_Wall(current, previous):
    ...
    wall_appear = previous < RIGHT_WALL_TARGET + 10 and current >= WALL_THRESHOLD
...
try:
    ...
    while True:
        ...
        new_right_mm = _clamp(new_right_mm, 20, 255)
